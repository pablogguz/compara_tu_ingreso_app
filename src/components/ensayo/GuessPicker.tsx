...
import { LIMITS } from '@/hooks/useFlow'
import { cx } from './copy'
  ...
  return (
    <div className={q.guess}>
      <p className={cx(q.hint, q.guessHint)} id="ensayo-guess-hint">
        Arriba a la izquierda está la persona con menos ingresos. Abajo a la derecha, la que tiene más. Elige el
        cuadrado que crees que eres tú, o mueve el control.
      </p>
      ...
      <div className={q.guessRead} aria-live="polite">
        ...
        <span className={q.guessReadNote}>
          {chosen === null
            ? 'Aún no has elegido.'
            : `Crees que ${chosen} de cada 100 personas tienen menos ingresos que tú.`}
        </span>
      </div>
